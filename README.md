# joint-project
brace around leg, supports movement forward with less effort on legs, transmits patient info to physician
GOAL: low cost orthosis to personalize recovery using whole-body kinematics
Target patients: Patients recovering from lower-limb orthopedic injury (ACL reconstruction, meniscus repair, knee surgery) transitioning from assisted mobility to independent walking.
- methods:
